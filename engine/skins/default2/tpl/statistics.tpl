...
<div class="row">
	<div
		...
		<div class="small-box bg-info">
			...
			<a href="{{ php_self }}?mod=news" class="small-box-footer">Больше информации
	...
	<div
		...
		<div class="small-box bg-success">
			...
			<a href="{{ php_self }}?mod=images" class="small-box-footer">Больше информации
				<i class="fa fa-arrow-right" aria-hidden="true"></i>
			</a>
		</div>
	</div>
	...
	<div
		...
		<div class="small-box bg-warning">
			...
			<a href="{{ php_self }}?mod=files" class="small-box-footer">Больше информации
				<i class="fa fa-arrow-right" aria-hidden="true"></i>
			</a>
		</div>
	</div>
	...
	<div
		...
		<div class="small-box bg-danger">
			...
			<a href="{{ php_self }}?mod=users" class="small-box-footer">Больше информации
				<i class="fa fa-arrow-right" aria-hidden="true"></i>
			</a>
		</div>
	</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<span class="input-group-btn">
									<button type="button" id="themes" class="btn btn-success">ok</button>
								</span>
							</div>
						</div>
					</div>
