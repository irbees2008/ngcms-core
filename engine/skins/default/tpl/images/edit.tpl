	...
	<div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item">
					<a href="{{ php_self }}?mod=images">{{ lang['images_title'] }}</a>
				</li>
...
<form method="post" action="admin.php">
	...
	<div class="card mb-5">
		<div class="card-header">{{ lang['edit_title'] }}</div>
		<div class="card-body">
					...
					<div class="input-group mb-3">
						...
						<div class="input-group-append">
							<span class="input-group-text">
								<a id="markNameEdit" href="#" title="{{ lang['rename'] }}">
				...
				<div class="col-sm-9">
					...
					{% else %}
						<label class="col-form-label d-block">
							<input name="createStamp" type="checkbox" value="1"/>
							{{ lang['add'] }}
						</label>
					{% endif %}
				</div>
	...
	<div class="card mb-5">
		<div class="card-header">{{ lang['preview'] }}</div>
		<div class="card-body">
			<div class="form-group row">
			...
			<div class="collapse" id="collapseEditPreview">
				<div class="form-group row">
					<label class="col-sm-3 col-form-label">{{ lang['size_max'] }},
						{{ lang['pixels'] }}</label>
					<div class="col-sm-4">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<label class="col-form-label d-block">
							<input type="checkbox" name="flagStamp" value="1"/>
							{{ lang['set_up'] }}
						</label>
					</div>
				</div>
...
$('#editImageName').removeAttr('readonly').attr('name', 'newname');
