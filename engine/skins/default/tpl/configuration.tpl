...
<form action="{{ php_self }}" method="post">
	...
	<ul class="nav nav-tabs nav-fill mb-3 d-md-flex d-block" role="tablist">
		...
		<li class="nav-item">
			<a href="#userTabs-security" class="nav-link" data-toggle="tab">{{ lang['security'] }}</a>
		</li>
		<li class="nav-item">
			<a href="#userTabs-system" class="nav-link" data-toggle="tab">{{ lang['syst'] }}</a>
		</li>
		<li class="nav-item">
			<a href="#userTabs-news" class="nav-link" data-toggle="tab">{{ lang['sn'] }}</a>
		</li>
		<li class="nav-item">
			<a href="#userTabs-users" class="nav-link" data-toggle="tab">{{ lang['users'] }}</a>
		</li>
		<li class="nav-item">
			<a href="#userTabs-imgfiles" class="nav-link" data-toggle="tab">{{ lang['files'] }}/{{ lang['img'] }}</a>
		</li>
		<li class="nav-item">
			<a href="#userTabs-cache" class="nav-link" data-toggle="tab">{{ lang['cache'] }}</a>
		</li>
		<li class="nav-item">
			<a href="#userTabs-multi" class="nav-link" data-toggle="tab">{{ lang['multi'] }}</a>
		</li>
		{% if canManageMultisite %}
			<li class="nav-item">
				<a href="#userTabs-multisite" class="nav-link" data-toggle="tab">{{ lang['multisite'] }}</a>
			</li>
		{% endif %}
	</ul>
	<div
		...
		<!-- ########################## DB TAB ########################## -->
		<div
			id="userTabs-db" class="tab-pane show active">
			<!-- TABLE DB//Connection -->
