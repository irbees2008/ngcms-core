		...
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu">
				{% for st in siteTemplates %}
					<a href="#" class="dropdown-item" data-teplate-mode="template" data-teplate-name="{{ st.name }}">{{ st.name }}
						({{ st.title }})</a>
				{% endfor %}
			</div>
		</li>
...
<div id="imageViewContainer" style="display: none; height: 578px; width: 100%; vertical-align: middle;"></div>
		...
		<div class="row">
			<div class="col-sm-5 col-md-3 pr-lg-0"></div>
			<div id="fileEditorButtonLine" class="col-sm-7 col-md-9 pl-lg-0">
				<button id="submitTemplateEdit" type="button" class="btn btn-outline-success">{{ lang['btn_save'] }}</button>
