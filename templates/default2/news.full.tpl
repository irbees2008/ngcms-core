			...
			<div class="col-lg-8 col-md-10">
				...
				<p class="post-meta clearfix">
					<span class="pull-left">
						...
						{% endif %}&nbsp;&nbsp;•&nbsp;&nbsp;{{ news.dateStamp|date }}
					</span>
					<span class="pull-right">
						<i class="fa fa-eye" title="{{ lang.views }}"></i>
						{{ news.views }}
						&nbsp;&nbsp;•&nbsp;&nbsp;
						{% if pluginIsActive('comments') %}
							<i class="fa fa-comments" title="{{ lang.com }}"></i>
							{comments-num}
						{% endif %}
					</span>
				</p>
				...
				{% if (news.flags.hasPagination) %}
					<!-- Pager -->
					<nav>
						<ul class="pagination justify-content-center">{{ news.pagination }}</ul>
					</nav>
				{% endif %}
			</div>
		</div>
...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-lg-8 col-md-10">
			{% if pluginIsActive('share') %}<hr class="alert-info">{{ plugin_share }}
			{% endif %}
