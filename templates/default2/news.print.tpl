...
<body onload="window.print();">
    <table border="0" width="100%" cellspacing="1" cellpadding="3">
        <tr></tr><td width="100%" class="header">
            <a href="{{ home }}"> {{ home_title }}</a> &raquo; {{ category }} &raquo; <a href="javascript:history.go(-1)">{{ title }}</a><hr>
        </td></tr>
        <tr><td width="100%">{short-story} {full-story}</td></tr>
        <tr><td width="100%"><hr><p class="footer">Дата: {{ news.dateStamp | cdate }} {l_by} {{ author }}<b style="float:right!important;">{{ home }}</b></p><hr></td>
        </tr>
    </table>
</body>
</html>
