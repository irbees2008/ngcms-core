...
function addcat() {
  if (
    ...
    document.getElementById("catmenu").value != ""
  ) {
    document.getElementById("categories").value =
      document.getElementById("categories").value +
      ", " +
  ...
  document.getElementById("catmenu").options[
    document.getElementById("catmenu").selectedIndex
  ] = null;
...
// --- Global site stickers (fallback if not defined in templates) ---
// Error sticker
if (typeof window !== "undefined" && typeof window.show_error !== "function") {
...
// Info sticker (auto close)
if (typeof window !== "undefined" && typeof window.show_info !== "function") {
  window.show_info = function (message) {
    try {
      var c = document.getElementById("ng-stickers");
      if (!c) {
        c = document.createElement("div");
      ...
      b.style.background = "#d1ecf1";
      b.style.border = "1px solid #bee5eb";
      b.style.color = "#0c5460";
      b.style.padding = "10px 14px";
      b.style.marginTop = "10px";
      b.style.borderRadius = "4px";
      b.style.boxShadow = "0 2px 8px rgba(0,0,0,.1)";
